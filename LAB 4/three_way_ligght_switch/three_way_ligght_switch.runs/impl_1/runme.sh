...
HD_PWD='C:/Users/student.CISCPL44.001/three_way_ligght_switch/three_way_ligght_switch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log three_way_light_switch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source three_way_light_switch.tcl -notrace
