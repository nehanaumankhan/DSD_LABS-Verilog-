...
HD_PWD='C:/Users/student.CISCPL44.001/three_way_ligght_switch/three_way_ligght_switch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log three_way_light_switch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source three_way_light_switch.tcl
