...
HD_PWD='C:/Users/student.CISCPL44.001/LAB3/LAB3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dec_3x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dec_3x8.tcl
