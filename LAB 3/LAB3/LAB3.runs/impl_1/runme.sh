...
HD_PWD='C:/Users/student.CISCPL44.001/LAB3/LAB3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec_3x8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dec_3x8.tcl -notrace
